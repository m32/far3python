...
#define PYPLUGIN_DEBUGLOG "w:/temp/far3.py.log"
...
#ifdef PYPLUGIN_THREADED
        if (!StartThread()) {
            python_log(__FUNCTION__, __LINE__, "StartThread failed, fallback to synchronous initialization\n");
            ThreadProc();
        }
#else
        ThreadProc();
...
{
    python_log(__FUNCTION__, __LINE__, "CloseAnalyseW\n", Info);
}

void     WINAPI ClosePanelW(const struct ClosePanelInfo *Info)
{
    python_log(__FUNCTION__, __LINE__, "ClosePanelW\n", Info);
}

intptr_t WINAPI CompareW(const struct CompareInfo *Info)
{
    python_log(__FUNCTION__, __LINE__, "CompareW\n", Info);
...
{
    python_log(__FUNCTION__, __LINE__, "ConfigureW\n", Info);
    intptr_t result = NULL;
    return result;
}
...
{
    python_log(__FUNCTION__, __LINE__, "DeleteFilesW\n", Info);
    intptr_t result = NULL;
    return result;
}
...
{
    python_log(__FUNCTION__, __LINE__, "ExitFARW\n", Info);
}
...
{
    python_log(__FUNCTION__, __LINE__, "GetFilesW\n", Info);
    intptr_t result = NULL;
    return result;
}
...
{
    python_log(__FUNCTION__, __LINE__, "GetFindDataW\n", Info);
    intptr_t result = NULL;
    return result;
}
...
{
    python_log(__FUNCTION__, __LINE__, "GetOpenPanelInfoW\n", Info);
}

void     WINAPI GetPluginInfoW(struct PluginInfo *Info)
{
    python_log(__FUNCTION__, __LINE__, "GetPluginInfoW\n");
...
{
    python_log(__FUNCTION__, __LINE__, "MakeDirectoryW\n", Info);
    intptr_t result = NULL;
    return result;
}
...
{
    python_log(__FUNCTION__, __LINE__, "OpenW\n", Info);
...
{
//    python_log(__FUNCTION__, __LINE__, "ProcessDialogEventW\n", Info);
    intptr_t result = NULL;
    return result;
}
...
{
//    python_log(__FUNCTION__, __LINE__, "ProcessEditorEventW\n", Info);
    intptr_t result = NULL;
    return result;
}
...
{
//    python_log(__FUNCTION__, __LINE__, "ProcessEditorInputW\n", Info);
    intptr_t result = NULL;
    return result;
}
...
{
//    python_log(__FUNCTION__, __LINE__, "ProcessPanelEventW\n", Info);
    intptr_t result = NULL;
    return result;
}
...
{
    python_log(__FUNCTION__, __LINE__, "ProcessHostFileW\n", Info);
    intptr_t result = NULL;
    return result;
}
...
{
//    python_log(__FUNCTION__, __LINE__, "ProcessPanelInputW\n", Info);
    intptr_t result = NULL;
    return result;
}
...
{
//    python_log(__FUNCTION__, __LINE__, "ProcessConsoleInputW\n", Info);
    intptr_t result = NULL;
    return result;
}
...
{
//    python_log(__FUNCTION__, __LINE__, "ProcessSynchroEventW\n", Info);
    intptr_t result = NULL;
    return result;
}
...
{
//    python_log(__FUNCTION__, __LINE__, "ProcessViewerEventW\n", Info);
    intptr_t result = NULL;
    return result;
}
...
{
    python_log(__FUNCTION__, __LINE__, "PutFilesW\n", Info);
    intptr_t result = NULL;
    return result;
}
...
{
    python_log(__FUNCTION__, __LINE__, "SetDirectoryW\n", Info);
    intptr_t result = NULL;
    return result;
}
...
{
    python_log(__FUNCTION__, __LINE__, "SetFindListW\n", Info);
    intptr_t result = NULL;
    return result;
}
...
{
    python_log(__FUNCTION__, __LINE__, "SetStartupInfoW\n", Info);
    ...
    python_log(__FUNCTION__, __LINE__, "SetStartupInfoW dir=%s\n", splugindir.c_str());
...
{
    python_log(__FUNCTION__, __LINE__, "GetContentFieldsW\n", Info);
    intptr_t result = NULL;
    return result;
}
...
{
    python_log(__FUNCTION__, __LINE__, "GetContentDataW\n", Info);
    intptr_t result = NULL;
    return result;
}
...
{
    python_log(__FUNCTION__, __LINE__, "FreeContentDataW\n", Info);
}
